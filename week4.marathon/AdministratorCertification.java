...
public class AdministratorCertification {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		System.out.println("The Adminstratro - Certification window has opened : " + title);
		...
		System.out.println("List of SalesForce Administrator certification" + certNames);
		
		WebElement certEle = driver.findElement(By.xpath("(//div[@class='credentials-card_title']//a)[7]"));
